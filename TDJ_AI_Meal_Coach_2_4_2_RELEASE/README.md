...
## 2.4.2
- LINE Login 後即納入總後台會員名單。
- 新增「未開通」狀態，區分「從未開通」與「已停用」。
- 未開通會員會固定出現在總後台「待開通會員」區，即使目前篩選為有效學員也不會漏掉。
- 可直接在待開通會員卡片開通 30 / 60 / 90 天並指定 TDJ 直營或顧問。


## 2.4.2 後台學員摘要補強
- 學員詳情摘要新增身高、年齡、BMI、性別。
- BMI 由目前身高與體重即時計算，不新增資料庫欄位。
- 原有目標、每日熱量、蛋白質、碳水、脂肪、飲水與方案資訊保留。
